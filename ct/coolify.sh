...
ADDON_SCRIPT="https://raw.githubusercontent.com/cgonzalezbermudez/ProxmoxVE/main/tools/addon/coolify.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/cgonzalezbermudez/ProxmoxVE/main/tools/addon/coolify.sh)"
MIGRATION_EOF
